    ...
    <footer className="footer">
      <div className="footer-content">
        ...
        <div className="footer-right">
          <h4>Social & Contato</h4>
          <a href="https://wa.me/5511998085903?text=Olá,%20vim%20através%20do%20site,%20gostaria%20de%20ter%20mais%20informações%20sobre%20o%20seu%20trabalho." className="whatsapp-link">
          ...
          <a href="https://www.instagram.com/seu-usuario" className="instagram-link">
      ...
      <div className="footer-bottom">
        <p>Karen Priscilla Sanchez Bustamante © 2024. Todos os Direitos Reservados ®</p>
        <p>
          Desenvolvido por{" "}
          <a href="https://www.linkedin.com/in/nicolaslopes29/" className="developer-link">
            Nicolas Lopes
          </a>
        </p>
      </div>
